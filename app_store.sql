...
-- Tiempo de generación: 14-09-2021 a las 03:34:00
...
CREATE TABLE IF NOT EXISTS `ticket` (
  ...
  KEY `id_pedido` (`id_pedido`)
) ENGINE=InnoDB AUTO_INCREMENT=1419 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`role`) REFERENCES `role_user` (`id_role`),
  ADD CONSTRAINT `user_ibfk_2` FOREIGN KEY (`id_empresa`) REFERENCES `empresa` (`id_empresa`);
COMMIT;
